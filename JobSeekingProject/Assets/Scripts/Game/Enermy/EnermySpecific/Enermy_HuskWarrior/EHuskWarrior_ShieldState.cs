...
public class EHuskWarrior_ShieldState : ShieldState
{
    private Enermy_HuskWarrior enermy;

    public EHuskWarrior_ShieldState(Entity entity, FiniteStateMachine stateMachine, string animBoolName, D_ShieldState stateData, Enermy_HuskWarrior enermy) : base(entity, stateMachine, animBoolName, stateData)
    {
        this.enermy = enermy;
    }
    ...
    public override void LogicUpdate()
    {
        ...
        else if (!isPlayerInMaxAgroRange && !isPlayerInShieldRange)
        {
